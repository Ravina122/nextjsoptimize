        ...
        <div className="hero_area">
            ...
            <div className="container">
              <nav className="navbar navbar-expand-lg custom_nav-container ">
                <a className="navbar-brand" href="index.html">
                  ...
                  <Image width={250} height={30} src="/../public/assets/images/logo.png" alt="Logo" />
                </a>
                <button
          ...
          <section className="slider_section ">
            <div className="slider_bg_box">
              {/* <Image src="images/slider-bg.jpg" alt="" /> */}
            </div>
          ...
          <div className="container">
            <div className="box">
              <div className="arrival_bg_box">
                <Image src="/../public/assets/images/arrival-bg.png" width={400} height={400} alt="" />
              </div>
              <div className="row">
            ...
            <div className="row">
              <div className="col-sm-6 col-md-4 col-lg-4">
                <div className="box">
                  ...
                  <div className="img-box">
                    <Image src="/../public/assets/images/p1.png" width={150} height={150} alt="" />
                  </div>
                  <div className="detail-box">
                    <h5>Men Shirt</h5>
                    <h6>$75</h6>
              ...
              <div className="col-sm-6 col-md-4 col-lg-4">
                <div className="box">
                  ...
                  <div className="img-box">
                    <Image src="/../public/assets/images/p2.png" width={150} height={150} alt="" />
                  </div>
                  <div className="detail-box">
                    <h5>Men Shirt</h5>
                    <h6>$80</h6>
              ...
              <div className="col-sm-6 col-md-4 col-lg-4">
                <div className="box">
                  ...
                  <div className="img-box">
                    <Image src="/../public/assets/images/p3.png" width={150} height={150} alt="" />
                  </div>
                  <div className="detail-box">
                    <h5>Women Dress</h5>
                    <h6>$68</h6>
              ...
              <div className="col-sm-6 col-md-4 col-lg-4">
                <div className="box">
                  ...
                  <div className="img-box">
                    <Image src="/../public/assets/images/p4.png" width={150} height={150} alt="" />
                  </div>
                  <div className="detail-box">
                    <h5>Women Dress</h5>
                    <h6>$70</h6>
              ...
              <div className="col-sm-6 col-md-4 col-lg-4">
                <div className="box">
                  ...
                  <div className="img-box">
                  <Image src="/../public/assets/images/p5.png" width={150} height={150} alt="" />
                  </div>
                  <div className="detail-box">
                    <h5>Women Dress</h5>
                    <h6>$75</h6>
              ...
              <div className="col-sm-6 col-md-4 col-lg-4">
                <div className="box">
                  ...
                  <div className="img-box">
                  <Image src="/../public/assets/images/p6.png" width={150} height={150} alt="" />
                  </div>
                  <div className="detail-box">
                    <h5>Women Dress</h5>
                    <h6>$58</h6>
              ...
              <div className="col-sm-6 col-md-4 col-lg-4">
                <div className="box">
                  ...
                  <div className="img-box">
                  <Image src="/../public/assets/images/p7.png" width={150} height={150} alt="" />
                  </div>
                  <div className="detail-box">
                    <h5>Women Dress</h5>
                    <h6>$80</h6>
              ...
              <div className="col-sm-6 col-md-4 col-lg-4">
                <div className="box">
                  ...
                  <div className="img-box">
                  <Image src="/../public/assets/images/p8.png" width={150} height={150} alt="" />
                  </div>
                  <div className="detail-box">
                    <h5>Men Shirt</h5>
                    <h6>$65</h6>
              ...
              <div className="col-sm-6 col-md-4 col-lg-4">
                <div className="box">
                  ...
                  <div className="img-box">
                  <Image src="/../public/assets/images/p9.png" width={150} height={150} alt="" />
                  </div>
                  <div className="detail-box">
                    <h5>Men Shirt</h5>
                    <h6>$65</h6>
              ...
              <div className="col-sm-6 col-md-4 col-lg-4">
                <div className="box">
                  ...
                  <div className="img-box">
                  <Image src="/../public/assets/images/p11.png" width={150} height={150} alt="" />
                  </div>
                  <div className="detail-box">
                    <h5>Men Shirt</h5>
                    <h6>$65</h6>
              ...
              <div className="col-sm-6 col-md-4 col-lg-4">
                <div className="box">
                  ...
                  <div className="img-box">
                  <Image src="/../public/assets/images/p12.png" width={150} height={150} alt="" />
                  </div>
                  <div className="detail-box">
                    <h5>Women Dress</h5>
                    <h6>$65</h6>
                    ...
                    <div className="img_container">
                      <div className="img-box">
                        <div className="img_box-inner">
                          ...
                          <Image src="/../public/assets/images/client.jpg" width={150} height={150} alt="" />
                        </div>
                      </div>
                    </div>
                    <div className="detail-box">
              ...
              <div className="col-md-4">
                <div className="full">
                  <div className="logo_footer">
                    <a href="#">
                      <Image src="/../public/assets/images/logo.png"  width={210} height={20} alt="#" />
                    </a>
                  </div>
