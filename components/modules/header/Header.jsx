...
const Header = () => {
  ...
  const handleSubmenu = (index) => {
    ...
    return (
  <header
        className={`relative header top-0 left-0 z-40 flex w-full items-center bg-transparent ${
          sticky
        ...
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-60 max-w-full px-4 xl:mr-12">
              ...
              >
                {/* <Image
                  src="/assets/images/BoppoLogo.svg"
                  alt="logo"
                  width={140}
                  height={30}
                  className="w-full dark:hidden"
                /> */}
                <span className='font-bold text-2xl'>Boppo</span>
                <Image
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                ...
                <nav
                  id="navbarCollapse"
                  className={`navbar absolute right-0 z-30 w-full rounded border-[.5px] border-body-color/50 bg-white py-4 px-6 duration-300 dark:border-body-color/20 dark:bg-dark lg:visible lg:static lg:w-auto lg:border-none lg:!bg-transparent lg:p-0 lg:opacity-100 ${
                    navbarOpen
