...
import GoogleSignIn from '../../components/svgcomponents/GoogleSignIn';


const Signin = () => {
    return (
      <section className="relative z-10 overflow-hidden pt-36 pb-16 md:pb-20 lg:pt-[30px] lg:pb-28">
